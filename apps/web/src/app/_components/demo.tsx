            ...
            <div className="mt-20  grid cols-1 md:grid-cols-5 gap-4 md:auto-rows-[25rem] max-w-7xl mx-auto">
                <Card className="flex flex-col justify-between md:col-span-3">
                    ...
                    <CardContent className="h-40">
                        ...
                        <CardDescription>
                            Deploy your app in seconds, with our one click
                            deploy feature.
                        </CardDescription>
                    </CardContent>
                </Card>
                ...
                <Card className="flex flex-col justify-between md:col-span-2">
                    <CardContent className="h-40">
                        ...
                        <CardDescription>
                            With our intuitive workflow, you can easily manage
                            your app without complex steps.
                        </CardDescription>
                    </CardContent>
                    <CardSkeletonBody>
                ...
                <Card className="flex flex-col justify-between md:col-span-2">
                    <CardContent className="h-40">
                        ...
                        <CardDescription>
                            With our edge network, we host your website by going
                            into each city by ourselves.
                        </CardDescription>
                    </CardContent>
                    <CardSkeletonBody>
                        <SkeletonTwo />
                ...
                <Card className="flex flex-col justify-between md:col-span-3">
                    <CardContent className="h-40">
                        ...
                        <CardDescription>
                            You are running out of copy for your website, we can
