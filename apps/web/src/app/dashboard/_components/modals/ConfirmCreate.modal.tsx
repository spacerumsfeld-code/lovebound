...
export const ConfirmCreateModal = (props: {
    ...
    const handleSubmit = async () => {
        ...
        if (
            props.creditCount <
            StoryLengthCostMap[
                props.storyData.length.name as unknown as StoryLengthEnum
            ]
        ) {
            toast(
            ...
            <ModalBody>
                <ModalContent className="flex flex-col overflow-y-auto">
                    ...
                    <p className="text-sm md:text-lg text-neutral-600 dark:text-neutral-100 text-center text-bold">
                        ...
                        {
                            StoryLengthCostMap[
                                props.storyData.length
                                    .name as unknown as StoryLengthEnum
                            ]
                        }{' '}
                        credits
                    </p>
                    {props.storyData?.scenes &&
                        props.storyData.scenes.length > 0 && (
                            <div className="mt-2 md:mt-4">
                                ...
                                {props.storyData.scenes.map((scene, index) => (
